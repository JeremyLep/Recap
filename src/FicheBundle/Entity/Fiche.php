...
class Fiche
{
     ...
     * @var \Membre
     *
     * @ORM\ManyToOne(targetEntity="GroupeBundle\Entity\Membre", inversedBy="fiche")
     */
    private $auteur;
     ...
     * @var \Groupe
     *
     * @ORM\ManyToOne(targetEntity="GroupeBundle\Entity\Groupe", inversedBy="fiche")
     */
    private $groupe;
     ...
     *
     * @ORM\ManyToMany(targetEntity="FicheBundle\Entity\Tag", inversedBy="fiche", cascade={"persist"})
     */
    private $tag;
     ...
     * @var \Commentaire
     *
     * @ORM\OneToMany(targetEntity="FicheBundle\Entity\Commentaire", mappedBy="fiche", cascade={"persist", "remove"})
     *
     */
    private $commentaire;
     ...
     * @var \Favoris
     *
     * @ORM\OneToMany(targetEntity="FicheBundle\Entity\Favoris", mappedBy="fiche", cascade={"persist", "remove"})
     *
     */
    private $favoris;
     ...
     * @var \Ressource
     *
     * @ORM\OneToMany(targetEntity="FicheBundle\Entity\Ressource", mappedBy="fiche", cascade={"persist", "remove"})
     *
     */
    private $ressource;
     ...
     * @var \Note
     *
     * @ORM\OneToMany(targetEntity="FicheBundle\Entity\Note", mappedBy="fiche", cascade={"persist", "remove"})
     *
     */
    protected $note;
     ...
     *
     * @ORM\OneToMany(targetEntity="AppBundle\Entity\Notification", mappedBy="fiche", cascade={"remove"})
     *
     */
     ...
     * Set auteur
     *
     * @param \GroupeBundle\Entity\Membre $auteur
     *
     * @return Fiche
     */
    public function setAuteur(\GroupeBundle\Entity\Membre $auteur = null)
    {
        $this->auteur = $auteur;
     ...
     * Add tag
     *
     * @param \FicheBundle\Entity\Tag $tag
     *
     * @return Fiche
     */
    public function addTag(\FicheBundle\Entity\Tag $tag)
    {
        $this->tag->add($tag);
     ...
     * @param \FicheBundle\Entity\Tag $tag
     */
    public function removeTag(\FicheBundle\Entity\Tag $tag)
    {
     ...
     * @return Collections\ArrayCollection
     */
    public function addNote(\FicheBundle\Entity\Note $note)
    {
        $this->note->add($note);
     ...
     * @return Fiche
     */
    public function addRessource(\FicheBundle\Entity\Ressource $ressource)
    {
     ...
     * @param \FicheBundle\Entity\Ressource $ressource
     */
    public function removeRessource(\FicheBundle\Entity\Ressource $ressource)
    {
