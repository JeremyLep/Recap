...
class Groupe
{
     ...
     * @var \Fiche
     *
     * @ORM\OneToMany(targetEntity="FicheBundle\Entity\Fiche", mappedBy="groupe", cascade={"remove"})
     *
     */
    private $fiche;
     ...
     * @return Groupe
     */
    public function addMembre(\GroupeBundle\Entity\Membre $membre)
    {
     ...
     * @param \GroupeBundle\Entity\Membre $membre
     */
    public function removeMembre(\GroupeBundle\Entity\Membre $membre)
    {
